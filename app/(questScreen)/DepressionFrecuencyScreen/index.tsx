...
const DepressionFrecuencyScreen = () => {
    ...
    <ThemedView margin className="flex-1 justify-between">
      <View className="flex-1 mt-5">
        ...
        <View className='justify-center flex-1 mb-10'>
          <SpeechBubble text="¿Con qué frecuencia has experimentado el sentirse deprimido/a o sin esperanza?" 
          source="Ventu" />
          <ThemedAvatar source={require('../../../assets/avatars/avatar-14.png')} animate />
          
          <ScaleSelector
          value={responses.frecuenciaDepresion}
          onValueChange={(value) => updateResponse('frecuenciaDepresion', value)}
          min={1}
          max={5}
          leftLabel="Nunca"
      ...
      <View className="mb-5">
        <ThemedButton 
          disabled={responses.frecuenciaDepresion === 0}
          route='ControlEmotionsScreen'
        >
          Continuar
        </ThemedButton>
      </View>
...
export default DepressionFrecuencyScreen